    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-1 text-center">
                <div className="flex justify-center gap-1 text-center pointer-events-none">
                    <input
                        ref={inputRef}
                        id={id}
                        type="file"
                    ...
                    <label htmlFor={id} className="flex cursor-pointer">
                        <Button color="link-color" size="md" isDisabled={isDisabled} className="pointer-events-none">
